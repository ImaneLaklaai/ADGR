...
class benevoles_table_seeder extends Seeder
{
    ...
    public function run()
    {
        Benevole::create(["nom" => "Hssine", "prenom" => "Anwar", "CIN" => "EE835735", "tele"=>"0639212599", "teleSec"=> "0612345678", "dateNaissance" => "1998-10-05", "email" => "anwarhssine@gmail.com", "profession" => "Etudiant", "sexe" => "H", "dateAdhesion" => "2019-05-10", "username" => "anwarhssine", "password" => bcrypt("123456789"), "adresse" => "Adresse", "etat_civil" => "1", "zone_id" => "1",  "role_id" => "1"]);
        Benevole::create(["nom" => "Laklaai", "prenom" => "Imane", "CIN" => "EE835734", "tele"=>"0639212598", "teleSec"=> "0612345677", "dateNaissance" => "1998-10-04", "email" => "ilaklaai@gmail.com", "profession" => "Etudiante", "sexe" => "F", "dateAdhesion" => "2019-05-09", "username" => "imanelaklaai", "password" => bcrypt("123456789"), "adresse" => "Adresse", "etat_civil" => "1", "zone_id" => "2", "role_id" => "1" ]);
